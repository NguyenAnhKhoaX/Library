    ...
    Themes = {
        NazuXHub = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(20, 20, 20)),   -- Đen nhạt
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(80, 80, 80)),   -- Xám trung
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 20, 20))    -- Đen nhạt
            }),
            ["Color Hub 2"] = Color3.fromRGB(30, 30, 30),   -- Xám đậm
            ["Color Stroke"] = Color3.fromRGB(150, 150, 150), -- Xám sáng
            ["Color Theme"] = Color3.fromRGB(200, 200, 200), -- Trắng xám
            ["Color Text"] = Color3.fromRGB(240, 240, 240),  -- Trắng sáng
            ["Color Dark Text"] = Color3.fromRGB(180, 180, 180) -- Xám nhạt
        }
    },
	Info = {
		Version = "1.1.0"
