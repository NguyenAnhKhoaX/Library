...
local function S6_func()
	...
	S13_.Parent = S12_
	S13_.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
	S13_.BackgroundTransparency = 0.3
	S13_.BorderSizePixel = 0
	S13_.AutoButtonColor = false
	S13_.Position = UDim2.new(0.1021, 0, 0.0743, 0)
	S13_.Size = UDim2.new(0, 60, 0, 60)
	S13_.Image = ""
	S13_.Visible = false
	
	-- Tạo UICorner bo tròn
	S11_ = Instance.new("UICorner")
	S11_.CornerRadius = UDim.new(1, 0)
	S11_.Parent = S13_
	
	-- Tạo UIStroke
	S10_ = Instance.new("UIStroke")
	S10_.Parent = S13_
	S10_.Color = Color3.fromRGB(0, 0, 0)
	S10_.Thickness = 1.5
	S10_.Transparency = 0.7
	
	-- Tạo ImageLabel cho icon
	local IconLabel = Instance.new("ImageLabel")
	IconLabel.Parent = S13_
	...
	IconLabel.Image = "rbxassetid://83367505278343"
	...
	-- Hiệu ứng hover
	S13_.MouseEnter:Connect(function()
		S2_:Create(
			S13_,
			TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			{
	...
	S13_.MouseLeave:Connect(function()
		S2_:Create(
			S13_,
			TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			{
	...
	-- Hiệu ứng click
	S13_.MouseButton1Down:Connect(function()
		S2_:Create(
			S13_,
...
function S9_:MakeNotify(S65_arg0)
	...
	S66_.Color = S66_.Color or Color3.fromRGB(255, 255, 255)
...
function S9_:MakeGui(S91_arg0)
	...
	S92_.Color = S92_.Color or Color3.fromRGB(255, 255, 255)
